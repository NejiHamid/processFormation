  ...
  <v-container fluid>
    ...
    <v-row class="bottom-space">
      ...
      >
        ...
        >
          <v-checkbox
            ...
            @click="
              checkFormation({
                index: key,
                value:
                  formation[currentNameColumnJoinWithSheetDetailsFormation],
              })
            "
            color="success"
          ></v-checkbox>
          ...
          <v-card-actions class="secondary" fixed>
            <v-btn
              color="success"
              tile
              :to="{
    ...
    >
      <span class="ver">
        ...
        >
        <v-icon color="white" @click="minimize" v-else class="minimize-icon"
      ...
      <div v-show="!minimizeAction">
        ...
        <v-btn color="green" text @click="checkAllFormations">
          Tout Cocher
        </v-btn>
      </div>
    </v-snackbar>
